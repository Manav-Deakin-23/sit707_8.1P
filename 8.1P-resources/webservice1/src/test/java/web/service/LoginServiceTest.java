...
public class LoginServiceTest {
	...
	public void testLoginSuccess() {
		...
		//
		driver.navigate().to(
				"file:///D:/java_projects/8.1P-resources/pages/login.html");
		sleep(5);
	...
	public void testLoginFailure() {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\manav\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		
		driver.navigate().to("file:///D:/java_projects/8.1P-resources/pages/login.html");
		sleep(5);
		...
		WebElement dobElement = driver.findElement(By.id("dob"));
		dobElement.clear();
		dobElement.sendKeys("26-02-2002"); // Assuming a valid date
	...
	public void testRegisterSuccess() {
		...
		driver.navigate().to("file:///D:/java_projects/8.1P-resources/pages/register.html");
		sleep(5);
	...
	public void testInvalidUsername() {
	    ...
	    WebElement passwordElement = driver.findElement(By.id("passwd"));
	    passwordElement.clear();
	    passwordElement.sendKeys("manav_pass");
	...
	public void testInvalidPassword() {
		...
		WebElement usernameElement = driver.findElement(By.id("username"));
		usernameElement.clear();
		usernameElement.sendKeys("manav");
	...
	public void testInvalidDOBFormat() {
		...
		WebElement dobElement = driver.findElement(By.id("dob"));
		dobElement.clear();
		dobElement.sendKeys("01*01*199"); // Invalid date format
